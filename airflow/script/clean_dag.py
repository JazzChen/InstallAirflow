...
query = {'delete from xcom where dag_id = "' + dag_input + '"',
        ...
        'delete from task_fail where dag_id = "' + dag_input + '"',
        ...
        'delete from dag_stats where dag_id = "' + dag_input + '"',
        'delete from dag where dag_id = "' + dag_input + '"' }

def connect(query):
        db = MySQLdb.connect(host="localhost", user="youruser", passwd="yourpasswd", db="yourdb")
        cur = db.cursor()
        cur.execute(query)
        db.commit()
        db.close()
